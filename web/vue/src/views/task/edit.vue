      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="标签">
            <el-input v-model="form.tag" placeholder="通过标签将任务分组"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
...
弱依赖: 无论主任务执行是否成功，都会运行子任务"
      ...
      <el-row>
        <el-col :span="7">
          <el-form-item label="任务类型">
            <el-select v-model="form.level" :disabled="form.id !== '' ">
              <el-option
        ...
        <el-col :span="7" v-if="form.level === 1">
          <el-form-item label="依赖关系">
            <el-select v-model="form.dependency_status">
              <el-option
        ...
        <el-col :span="10">
          <el-form-item label="子任务ID" v-if="form.level === 1">
            <el-input v-model="form.dependency_task_id" placeholder="多个ID逗号分隔"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-if="form.level === 1">
      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-select v-model="form.project_id" prop="project_id">
        ...
        <el-col :span="8" v-if="form.protocol === 1 ">
          <el-form-item label="请求方法">
            <el-select key="http-method" v-model="form.http_method">
              <el-option
        ...
        <el-col :span="24" v-else>
          <el-form-item label="任务节点">
            <el-select key="shell" v-model="selectedHosts" filterable multiple placeholder="请选择" style="width: 100%">
              <el-option
                  v-for="item in hosts"
                  :key="item.id"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="任务失败重试次数" prop="retry_times">
            <el-input v-model.number="form.retry_times"
                      placeholder="0 - 10, 默认0，不重试"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="任务失败重试间隔时间" prop="retry_interval">
            <el-input v-model.number="form.retry_interval" placeholder="0 - 3600 (秒), 默认0，执行系统默认策略"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="8">
          <el-form-item label="任务通知">
            <el-select v-model="form.notify_status">
              <el-option
        ...
        <el-col :span="8" v-if="form.notify_status !== 1">
          <el-form-item label="通知类型">
            <el-select v-model="form.notify_type">
              <el-option
      ...
      <el-row v-if="form.notify_status === 4">
        <el-col :span="12">
          <el-form-item label="任务执行输出关键字" prop="notify_keyword">
            <el-input v-model="form.notify_keyword" placeholder="任务执行输出中包含此关键字将触发通知"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
  ...
  methods: {
    submit() {
      this.$refs['form'].validate((valid) => {
        ...
        if (this.form.protocol === 2 && !this.form.project_id && this.selectedHosts.length === 0) {
