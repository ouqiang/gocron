...
弱依赖: 无论主任务执行是否成功，都会运行子任务"
        ...
        <el-row v-if="form.level === 1">
          <el-col :span="8">
            <el-form-item label="crontab表达式" prop="spec">
              <el-input v-model.trim="form.spec" placeholder class="inp"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="2">
            <el-form-item class="cron">
              <el-button type="primary" @click="showDialog">编辑 cron</el-button>
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item>
              <el-dialog title="编辑 cron" :visible.sync="showCron">
        ...
        <el-row>
          <el-col>
            <el-alert title="任务执行超时强制结束, 取值0-86400(秒), 默认0, 不限制" type="info" :closable="false"></el-alert>
            <el-alert
        ...
        <el-row>
          ...
          <el-col :span="8" v-if="form.notify_status !== 1 && form.notify_type === 2">
          ...
          <el-col :span="8" v-if="form.notify_status !== 1 && form.notify_type === 3">
        ...
        <el-row>
          <el-col :span="16">
            <el-form-item label="备注">
              <el-input type="textarea" :rows="3" size="medium" width="100" v-model="form.remark"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item>
...
export default {
  ...
  components: { taskSidebar, vcrontab },
  created () {
  ...
  methods: {
    ...
    showDialog () {
      this.expression = this.form.spec
      this.showCron = true
    }
  }
}
